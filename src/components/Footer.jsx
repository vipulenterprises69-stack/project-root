      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Empowering students with professional-grade projects for their final year and diploma requirements.
              Quality code, complete documentation, and reliable support.
            </p>
              ...
              {[
                ...
                <li key={link.name}>
                  <Link
                    ...
                    onClick={() => link.path.startsWith('/#') && scrollToSection(link.path.substring(2))}
                  >
                    {link.name}
                  </Link>
                </li>
        ...
        >
          <p className="text-gray-400">
            © All Rights Reserved Code4Degree | Powered by Vipul Enterprises
          </p>
        </motion.div>
      </div>
    </footer>
